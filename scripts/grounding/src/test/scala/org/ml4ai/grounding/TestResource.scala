...
import org.ml4ai.grounding.common.utils.BuildUtils
import org.ml4ai.grounding.common.utils.Sourcer
...
class TestResource extends Test {
  ...
  it should "be accessible" in {
    ...
    println(getTextFromResource("/" + BuildUtils.pkgToDir("org.ml4ai.grounding") + "/resource.txt"))
  }
}
