...
"""Simulate SIR model forward in time, returning a dictionary of daily arrays parameter order has changed to allow multiple (beta, n_days) to reflect multiple changing social distancing policies."""
def sim_sir(
