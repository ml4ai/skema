...
if __name__ == "__main__":
    ...
    parser.add_argument("-b", "--base_path", help="Base path of the directory with the files to align")
    parser.add_argument("-e", "--embeddings_path", help="Path of the embeddings model used for alignment")
    parser.add_argument("-g", "--gromet_name", help="Gromet FN file name")
    parser.add_argument("-c", "--comments_name", help="Code comments file name")
    parser.add_argument("-x", "--extractions_name", help="TR extractions file name")
