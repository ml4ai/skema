...
import org.ml4ai.skema.text_reading.utils.AlignmentJsonUtils.{GlobalEquationVariable, GlobalSrcVariable, GlobalVariable}
...
import org.ml4ai.skema.text_reading.grfn.GrFNParser.mkHypothesis
import AlignmentBaseline.{greek2wordDict, word2greekDict}
