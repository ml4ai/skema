...
def process_file(path: str, write_to_file=False, original_source=False, dependency_depth=0) -> GrometFNModuleCollection:
    ...
    gromet_collection = process_file_system(
        system_name, root_path, tmp.name, write_to_file, original_source, dependency_depth
    )
...
if __name__ == "__main__":
    ...
    process_file(args.path, True, args.source, args.dependency_depth)
