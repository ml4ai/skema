...
import six
from skema.program_analysis.CAST2GrFN.model.cast.ast_node import (
    AstNode,
)  # noqa: F401,E501
...
class Loop(AstNode):
    ...
    attribute_map = {"init": "init", "expr": "expr", "body": "body"}
    if hasattr(AstNode, "attribute_map"):
        attribute_map.update(AstNode.attribute_map)

    def __init__(
        self, init=None, expr=None, body=None, *args, **kwargs
    ):  # noqa: E501
