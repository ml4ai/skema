    ...
    if let MathExpressionTree::Atom(i) = input {
        ...
        match head {
            ...
            Operator::Derivative(Derivative {
                ...
                } else if *derivative_notation == DerivativeNotation::LeibnizTotal {
