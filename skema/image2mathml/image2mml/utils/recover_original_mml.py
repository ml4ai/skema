...
if __name__ == "__main__":
    ...
    os.rename("logs/test_targets_100K_recovered.txt", "logs/test_targets_100K.txt")
    os.rename("logs/test_predicted_100K_recovered.txt", "logs/test_predicted_100K.txt")
