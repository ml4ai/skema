...
class Metadata(object):
    ...
    attribute_map = {
        'is_metadatum': 'is_metadatum',
        'provenance': 'provenance'
    }

    def __init__(self, is_metadatum=True, provenance=None):  # noqa: E501
        """Metadata - a model defined in Swagger"""  # noqa: E501
        self._is_metadatum = None
        self._provenance = None
        self.discriminator = None
        if is_metadatum is not None:
            self.is_metadatum = is_metadatum
        if provenance is not None:
            self.provenance = provenance

    @property
    def is_metadatum(self):
        """Gets the is_metadatum of this Metadata.  # noqa: E501


        :return: The is_metadatum of this Metadata.  # noqa: E501
        :rtype: bool
        """
        return self._is_metadatum

    @is_metadatum.setter
    def is_metadatum(self, is_metadatum):
        """Sets the is_metadatum of this Metadata.


        :param is_metadatum: The is_metadatum of this Metadata.  # noqa: E501
        :type: bool
        """

        self._is_metadatum = is_metadatum
