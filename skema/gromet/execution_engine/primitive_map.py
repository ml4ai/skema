...
import skema.gromet.execution_engine.types
from skema.gromet.execution_engine.types import (
    array,
    binary,
    indexable,
    iterable,
...
submodules = inspect.getmembers(
    skema.gromet.execution_engine.types, predicate=inspect.ismodule
)
primitive_ops = []
