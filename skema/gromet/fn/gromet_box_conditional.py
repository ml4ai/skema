...
class GrometBoxConditional(GrometBox):
    ...
    def __init__(self, condition=None, body_if=None, body_else=None, gromet_type='GrometBoxConditional', *args, **kwargs):  # noqa: E501
    ...
    def condition(self):
        ...
        The index to the entry in the `fn_array` table of the GrometFNModule representing the GrometFN implementing the conditional condition.   # noqa: E501
    ...
    def body_if(self):
        ...
        The index to the entry in the `fn_array` table of the GrometFNModule representing the GrometFN implementing the IF-branch of the conditional.   # noqa: E501
    ...
    def body_else(self):
        ...
        The index to the entry in the `fn_array` table of the GrometFNModule representing the GrometFN implementing the ELSE-branch of the conditional.   # noqa: E501
    ...
    def gromet_type(self):
        """Gets the gromet_type of this GrometBoxConditional.  # noqa: E501


        :return: The gromet_type of this GrometBoxConditional.  # noqa: E501
        :rtype: str
        """
    ...
    def gromet_type(self, gromet_type):
        """Sets the gromet_type of this GrometBoxConditional.


        :param gromet_type: The gromet_type of this GrometBoxConditional.  # noqa: E501
        :type: str
        """
